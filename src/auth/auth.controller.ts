...
export async function sanitizeAuthInput(req: Request, res: Response, next: NextFunction) {
...
export const SignUp = async (req: Request, res: Response) => {
    try {
        ...
        if (existingUser) {
            ...
            if (existingUser.nro_doc === nro_doc) throw new Error("El número de documento ya está registrado.");
            if (existingUser.telefono === telefono) throw new Error("El teléfono ya está registrado.");
        }
